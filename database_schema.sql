...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `is_inactivated_by_admin` boolean DEFAULT FALSE,
...
INSERT INTO `users` (`id`, `ip_address`, `username`, `password`, `salt`, `email`, `activation_code`, `forgotten_password_code`, `remember_code`, `created_on`, `last_login`, `active`, `first_name`, `last_name`, `country`,`browser`) VALUES
(1, '127.0.0.1', 'administrator', '59beecdf7fc966e2f17fd8f65a4a9aeb09d4a3d4', '9462e8eee0', 'admin@admin.com', '', NULL, NULL, 1268889823, 1333518170, 1, 'Admin', 'istrator', 'US','Mozilla Firefox'),
(2, '127.0.0.1', 'alamgir kabir', 'b98de0d98b4f9500b9e948134b97f15fc32fe4c1', NULL, 'alamgir@apurbatech.com', NULL, NULL, NULL, 1331880273, 1331880718, 1, 'alamgir', 'kabir', 'US','Mozilla Firefox'),
(3, '127.0.0.1', 'nazmul hasan', 'f52b7fd2b530da40fdb4e701abd93cb36f8ceb41', NULL, 'nazmul@apurbatech.com', NULL, NULL, 'a062b8cc4e50b3ad32519fc5b99646e6f25c86dd', 1333518258, 1333630086, 1, 'nazmul', 'hasan', 'US','Mozilla Firefox');
